# SCOPE: os-only
"""Portability proof for rules/parry-integration.md."""
...
ARTIFACT = REPO_ROOT / "rules/parry-integration.md"


def test_test_parry_integration_loads_from_arbitrary_project_root(tmp_path: Path) -> None:
