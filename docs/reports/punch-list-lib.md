...
|------|----------------|---------------|-------------------|
| `lib/jupyter_client.py` | DORMANT | callers=0, size_bytes=9418, no test coverage, no @on-demand marker | PROVE or PRUNE: write a unit test that imports and exercises it, or archive to docs/archive/lib/ |
