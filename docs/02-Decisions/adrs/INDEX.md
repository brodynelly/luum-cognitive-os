...
| [322](ADR-322-consumer-sdd-lane-contract.md) | Consumer SDD Lane Contract | accepted | partial | 2026-05-15 | Accepted. |
...
| [039](ADR-039-reinvention-phase-b-beta.md) | Reinvention Phase B-β (semantic embeddings) | proposed | planned | 2026-04-20 | > Originally drafted in `.cognitive-os/pending-tasks/adr-039-reinvention-phase-b-beta.md`; canonical location is `docs/02-Decisions/adrs/`. |
