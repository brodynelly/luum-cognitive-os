...
# SCOPE: os-only
"""
scope-tag-backfill.py — Add SCOPE: header to files that lack one.

Usage:
  python3 scripts/scope-tag-backfill.py          # dry-run (default)
  python3 scripts/scope-tag-backfill.py --apply  # write changes
