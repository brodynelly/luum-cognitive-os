# SCOPE: os-only
"""Portability proof for rules/prompt-composition.md."""
...
ARTIFACT = REPO_ROOT / "rules/prompt-composition.md"


def test_test_prompt_composition_loads_from_arbitrary_project_root(tmp_path: Path) -> None:
