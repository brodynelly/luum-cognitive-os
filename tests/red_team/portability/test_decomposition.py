# SCOPE: os-only
"""Portability proof for rules/decomposition.md."""
...
ARTIFACT = REPO_ROOT / "rules/decomposition.md"


def test_test_decomposition_loads_from_arbitrary_project_root(tmp_path: Path) -> None:
