# SCOPE: os-only
"""Portability proof for rules/ai-provider-identity.md."""
...
ARTIFACT = REPO_ROOT / "rules/ai-provider-identity.md"


def test_test_ai_provider_identity_loads_from_arbitrary_project_root(tmp_path: Path) -> None:
