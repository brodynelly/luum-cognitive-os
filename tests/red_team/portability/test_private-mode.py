# SCOPE: os-only
"""Portability proof for rules/private-mode.md."""
...
ARTIFACT = REPO_ROOT / "rules/private-mode.md"


def test_test_private_mode_loads_from_arbitrary_project_root(tmp_path: Path) -> None:
