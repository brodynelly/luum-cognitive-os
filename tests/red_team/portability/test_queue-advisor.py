# SCOPE: os-only
"""Portability proof for rules/queue-advisor.md."""
...
ARTIFACT = REPO_ROOT / "rules/queue-advisor.md"


def test_test_queue_advisor_loads_from_arbitrary_project_root(tmp_path: Path) -> None:
