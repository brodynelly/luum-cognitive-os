# SCOPE: os-only
"""Portability proof for rules/squad-protocol.md."""
...
ARTIFACT = REPO_ROOT / "rules/squad-protocol.md"


def test_test_squad_protocol_loads_from_arbitrary_project_root(tmp_path: Path) -> None:
