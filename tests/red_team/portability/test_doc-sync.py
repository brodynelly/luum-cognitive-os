# SCOPE: os-only
"""Portability proof for rules/doc-sync.md."""
...
ARTIFACT = REPO_ROOT / "rules/doc-sync.md"


def test_test_doc_sync_loads_from_arbitrary_project_root(tmp_path: Path) -> None:
