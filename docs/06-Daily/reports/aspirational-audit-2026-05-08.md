# Aspirational Audit — 2026-05-08

## Summary

| Metric | Value |
|--------|-------|
| Total components | 1019 |
| REAL | 317 |
| DORMANT | 182 |
| ASPIRATIONAL | 36 |
| METADATA | 61 |
| DORMANT + ASPIRATIONAL ratio | 21.4% |
...
| `hooks/adaptive-bypass.sh` | REAL | fire_count_7d=18, registered=True | fires actively (18 rows in hook-health.jsonl last 7d) |
...
| `hooks/agent-launch-confirmed.sh` | REAL | fire_count_7d=18, registered=True | fires actively (18 rows in hook-health.jsonl last 7d) |
...
| `hooks/assumption-tracker.sh` | REAL | fire_count_7d=16, registered=True | fires actively (16 rows in hook-health.jsonl last 7d) |
...
| `hooks/auto-refine.sh` | REAL | fire_count_7d=16, registered=True | fires actively (16 rows in hook-health.jsonl last 7d) |
| `hooks/auto-repair-dispatcher.sh` | REAL | fire_count_7d=16, registered=True | fires actively (16 rows in hook-health.jsonl last 7d) |
| `hooks/auto-rollback-trigger.sh` | REAL | fire_count_7d=16, registered=True | fires actively (16 rows in hook-health.jsonl last 7d) |
...
| `hooks/auto-verify.sh` | REAL | fire_count_7d=16, registered=True | fires actively (16 rows in hook-health.jsonl last 7d) |
...
| `hooks/blast-radius.sh` | REAL | fire_count_7d=18, registered=True | fires actively (18 rows in hook-health.jsonl last 7d) |
...
| `hooks/claim-validator.sh` | REAL | fire_count_7d=16, registered=True | fires actively (16 rows in hook-health.jsonl last 7d) |
| `hooks/clarification-gate.sh` | REAL | fire_count_7d=18, registered=True | fires actively (18 rows in hook-health.jsonl last 7d) |
...
| `hooks/confidence-gate.sh` | REAL | fire_count_7d=16, registered=True | fires actively (16 rows in hook-health.jsonl last 7d) |
...
| `hooks/destructive-git-blocker.sh` | REAL | fire_count_7d=347, registered=True | fires actively (347 rows in hook-health.jsonl last 7d) |
| `hooks/destructive-rm-blocker.sh` | REAL | fire_count_7d=347, registered=True | fires actively (347 rows in hook-health.jsonl last 7d) |
| `hooks/direct-main-guard.sh` | REAL | fire_count_7d=348, registered=True | fires actively (348 rows in hook-health.jsonl last 7d) |
...
| `hooks/doc-sync-detector.sh` | REAL | fire_count_7d=27, registered=True | fires actively (27 rows in hook-health.jsonl last 7d) |
...
| `hooks/dod-gate.sh` | REAL | fire_count_7d=16, registered=True | fires actively (16 rows in hook-health.jsonl last 7d) |
...
| `hooks/engram-obsidian-export-on-stop.sh` | REAL | fire_count_7d=19, registered=True | fires actively (19 rows in hook-health.jsonl last 7d) |
...
| `hooks/error-learning.sh` | REAL | fire_count_7d=313, registered=True | fires actively (313 rows in hook-health.jsonl last 7d) |
...
| `hooks/error-pipeline.sh` | REAL | fire_count_7d=313, registered=True | fires actively (313 rows in hook-health.jsonl last 7d) |
...
| `hooks/large-file-advisor.sh` | REAL | fire_count_7d=29, registered=True | fires actively (29 rows in hook-health.jsonl last 7d) |
...
| `hooks/mcp-scan.sh` | REAL | fire_count_7d=2, registered=True | fires actively (2 rows in hook-health.jsonl last 7d) |
...
| `hooks/post-agent-snapshot-restore.sh` | REAL | fire_count_7d=3, registered=True | fires actively (3 rows in hook-health.jsonl last 7d) |
| `hooks/post-agent-verify.sh` | REAL | fire_count_7d=16, registered=True | fires actively (16 rows in hook-health.jsonl last 7d) |
| `hooks/post-git-orphan-notifier.sh` | REAL | fire_count_7d=313, registered=True | fires actively (313 rows in hook-health.jsonl last 7d) |
...
| `hooks/reinvention-check.sh` | REAL | fire_count_7d=24, registered=True | fires actively (24 rows in hook-health.jsonl last 7d) |
...
| `hooks/result-truncator.sh` | REAL | fire_count_7d=313, registered=True | fires actively (313 rows in hook-health.jsonl last 7d) |
| `hooks/review-spawner.sh` | REAL | fire_count_7d=16, registered=True | fires actively (16 rows in hook-health.jsonl last 7d) |
...
| `hooks/secret-detector.sh` | REAL | fire_count_7d=379, registered=True | fires actively (379 rows in hook-health.jsonl last 7d) |
...
| `hooks/session-learning.sh` | REAL | fire_count_7d=20, registered=True | fires actively (20 rows in hook-health.jsonl last 7d) |
...
| `hooks/skill-feedback-tracker.sh` | REAL | fire_count_7d=16, registered=True | fires actively (16 rows in hook-health.jsonl last 7d) |
...
| `hooks/skill-tracker.sh` | REAL | fire_count_7d=16, registered=True | fires actively (16 rows in hook-health.jsonl last 7d) |
...
| `hooks/surface-fix-detector.sh` | REAL | fire_count_7d=27, registered=True | fires actively (27 rows in hook-health.jsonl last 7d) |
...
| `hooks/tool-sequence-capture.sh` | REAL | fire_count_7d=403, registered=True | fires actively (403 rows in hook-health.jsonl last 7d) |
| `hooks/trust-score-validator.sh` | REAL | fire_count_7d=16, registered=True | fires actively (16 rows in hook-health.jsonl last 7d) |
| `hooks/untracked-work-preservation-guard.sh` | REAL | fire_count_7d=348, registered=True | fires actively (348 rows in hook-health.jsonl last 7d) |
...
| `hooks/work-queue-sync.sh` | REAL | fire_count_7d=16, registered=True | fires actively (16 rows in hook-health.jsonl last 7d) |
...
| `lib/agent_daemon.py` | ON_DEMAND | callers=0, has_test=True, size_bytes=17501 | covered by test — legit sleeper (imported by test only) |
...
| `lib/agent_team_transport.py` | ON_DEMAND | callers=0, has_test=True, size_bytes=7653 | covered by test — legit sleeper (imported by test only) |
...
| `lib/claude_executor.py` | REAL | callers=7, size_bytes=37585 | imported by 7 non-test caller(s) |
...
| `lib/cross_stack_adoption_truth.py` | ON_DEMAND | callers=0, has_test=True, size_bytes=10950 | covered by test — legit sleeper (imported by test only) |
| `lib/cross_stack_license_audit.py` | ON_DEMAND | callers=0, has_test=True, size_bytes=6697 | covered by test — legit sleeper (imported by test only) |
...
| `lib/deferred_tool_loading.py` | ON_DEMAND | callers=0, has_test=True, size_bytes=6612 | covered by test — legit sleeper (imported by test only) |
...
| `lib/dependency_adoption_gate.py` | ON_DEMAND | callers=0, has_test=True, size_bytes=7649 | covered by test — legit sleeper (imported by test only) |
| `lib/dispatch.py` | REAL | callers=8, size_bytes=41480 | imported by 8 non-test caller(s) |
| `lib/dispatch_cost_predictor.py` | ON_DEMAND | callers=0, has_test=True, size_bytes=2748 | covered by test — legit sleeper (imported by test only) |
| `lib/dispatch_gate.py` | REAL | callers=1, size_bytes=6284 | imported by 1 non-test caller(s) |
...
| `lib/history_sanitization.py` | ON_DEMAND | callers=0, has_test=True, size_bytes=27590 | covered by test — legit sleeper (imported by test only) |
...
| `lib/memory_retriever.py` | REAL | callers=1, size_bytes=9406 | imported by 1 non-test caller(s) |
...
| `lib/model_catalog.py` | REAL | callers=1, size_bytes=17399 | imported by 1 non-test caller(s) |
...
| `lib/prompt_classifier.py` | REAL | callers=2, size_bytes=9683 | imported by 2 non-test caller(s) |
...
| `lib/qwen_provider.py` | REAL | callers=5, size_bytes=13296 | imported by 5 non-test caller(s) |
...
| `lib/retry_classifier.py` | REAL | callers=1, size_bytes=3025 | imported by 1 non-test caller(s) |
...
| `lib/safe_engram.py` | REAL | callers=2, size_bytes=7678 | imported by 2 non-test caller(s) |
| `lib/sandbox_adapter.py` | ON_DEMAND | callers=0, has_test=True, size_bytes=5898 | covered by test — legit sleeper (imported by test only) |
...
| `lib/service_mode_readiness.py` | ON_DEMAND | callers=0, has_test=True, size_bytes=13025 | covered by test — legit sleeper (imported by test only) |
...
| `lib/skill_router.py` | REAL | callers=4, size_bytes=70129 | imported by 4 non-test caller(s) |
...
| `lib/snapshot_manager.py` | REAL | callers=10, size_bytes=23716 | imported by 10 non-test caller(s) |
...
| `lib/stash_sha.py` | ON_DEMAND | callers=0, has_test=True, size_bytes=2559 | covered by test — legit sleeper (imported by test only) |
...
| `lib/worktree_audit.py` | ON_DEMAND | callers=0, has_test=True, size_bytes=8523 | covered by test — legit sleeper (imported by test only) |
...
| `scripts/apply-efficiency-profile.sh` | REAL | writes_jsonl=True, size_bytes=14738 | writes to an existing metrics JSONL file |
...
| `scripts/audit-consumer-dependence.sh` | DORMANT | callers=0, size_bytes=3572 | no observable production use, no test, no on-demand marker |
...
| `scripts/check_lib_wiring.py` | ON_DEMAND | callers=0, has_test=True, size_bytes=4193 | covered by test — legit sleeper (test proves it works when called) |
...
| `scripts/cos_false_positive_ledger.py` | REAL | writes_jsonl=True, size_bytes=4826 | writes to an existing metrics JSONL file |
...
| `scripts/cos_work_inventory.py` | REAL | writes_jsonl=True, size_bytes=67759 | writes to an existing metrics JSONL file |
...
| `scripts/credibility-audit.sh` | DORMANT | callers=0, size_bytes=17238 | no observable production use, no test, no on-demand marker |
...
| `scripts/install-credibility-tools.sh` | DORMANT | callers=0, size_bytes=2054 | no observable production use, no test, no on-demand marker |
...
| `scripts/install-git-filter-repo.sh` | DORMANT | callers=0, size_bytes=3581 | no observable production use, no test, no on-demand marker |
...
| `scripts/install-trivy.sh` | ON_DEMAND | callers=0, has_test=True, size_bytes=2887 | covered by test — legit sleeper (test proves it works when called) |
...
| `scripts/license-audit-syft-grype.sh` | DORMANT | callers=0, size_bytes=1755 | no observable production use, no test, no on-demand marker |
| `scripts/license-audit-trivy.sh` | ON_DEMAND | callers=0, has_test=True, size_bytes=3537 | covered by test — legit sleeper (test proves it works when called) |
...
| `scripts/mcp_tofu_audit.py` | ON_DEMAND | callers=0, has_test=True, size_bytes=4387 | covered by test — legit sleeper (test proves it works when called) |
...
| `scripts/migrate_event_log_to_v2.py` | ON_DEMAND | callers=0, has_test=True, size_bytes=2962 | covered by test — legit sleeper (test proves it works when called) |
...
| `scripts/validate_substrate_consumers.py` | DORMANT | callers=0, size_bytes=10529 | no observable production use, no test, no on-demand marker |
