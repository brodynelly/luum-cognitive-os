# SCOPE: os-only
"""Portability proof for rules/assumption-tracking.md."""
...
ARTIFACT = REPO_ROOT / "rules/assumption-tracking.md"


def test_test_assumption_tracking_loads_from_arbitrary_project_root(tmp_path: Path) -> None:
