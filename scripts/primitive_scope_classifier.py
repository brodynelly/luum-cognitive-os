...
SHARED_HOOK_NAME_PATTERNS = {
    ...
    "agent-bash-cwd-enforcer": "shared-subagent-worktree-safety",
    "agent-checkpoint": "shared-subagent-task-lifecycle",
    "agent-control-inbound-guard": "shared-agent-control-plane-safety",
    "agent-launch-confirmed": "shared-subagent-safety",
    "agent-message-inbox": "shared-agent-coordination",
    "agent-output-verifier": "shared-claim-verification",
    "agent-prelaunch": "shared-subagent-task-lifecycle",
    "agent-qwen-bridge": "shared-provider-routing",
    "agent-working-dir-inject": "shared-subagent-worktree-safety",
    ...
    "orchestrator-claim-gate": "shared-orchestrator-safety",
    "orchestrator-decision-trace": "shared-orchestrator-observability",
    "orchestrator-mode-detect": "shared-orchestrator-diagnostics",
    "orchestrator-skill-invocation-gate": "shared-orchestrator-governance",
    ...
    "subagent-capability-preflight": "shared-subagent-safety",
    "subagent-context-injector": "shared-subagent-context",
    "task-completed": "shared-team-task-governance",
    "task-created": "shared-team-task-governance",
    "teammate-idle": "shared-team-task-coordination",
    ...
    "audit-id-enricher": "shared-audit-observability",
    "auto-refine": "shared-agent-recovery",
    "auto-repair-dispatcher": "shared-agent-recovery",
    "clarification-interceptor": "shared-agent-workflow-quality",
    "completion-gate": "shared-delivery-quality",
    "consequence-evaluator": "shared-governance-quality",
    "cosd-auth-guard": "shared-runtime-security",
    "cross-session-coordination-guard": "shared-cross-session-safety",
    "cross-session-event-emit": "shared-cross-session-coordination",
    "cross-session-peer-context": "shared-cross-session-coordination",
    "document-ingest-guard": "shared-document-safety",
    "epic-task-detector": "shared-launch-safety",
    "error-learning": "shared-agent-recovery",
    "error-pattern-detector": "shared-agent-recovery",
    "error-pipeline": "shared-agent-recovery",
    "git-context-capture": "shared-repository-audit",
    "host-tool-doctor": "shared-runtime-health",
    "inject-phase-context": "shared-project-phase-context",
    "memory-prefetch": "shared-memory-workflow",
    "pending-truth-drift-detector": "shared-planning-truth-governance",
    "pending-truth-staleness-gate": "shared-planning-truth-governance",
    "pending-truth-verify-weekly": "shared-planning-truth-governance",
    "plan-claim-validator": "shared-planning-truth-governance",
    "pre-compaction-flush": "shared-memory-hygiene",
    "project-docs-convention": "shared-documentation-governance",
    "query-tailored-context-inject": "shared-context-quality",
    "rate-limit-protection": "shared-runtime-budget",
    "research-quality-validator": "shared-research-quality",
    "result-truncator": "shared-context-hygiene",
    "session-cleanup": "shared-session-lifecycle",
    "session-end-cleanup": "shared-session-lifecycle",
    "session-heartbeat": "shared-session-lifecycle",
    "session-init": "shared-session-lifecycle",
    "session-learning": "shared-continuous-improvement",
    "session-sanity": "shared-session-lifecycle",
    "session-startup-protocol": "shared-session-governance",
    "session-summary-reminder": "shared-memory-hygiene",
    "session-wrapup-trigger": "shared-session-lifecycle",
    "state-retention-audit": "shared-state-hygiene",
    "surface-fix-detector": "shared-decision-depth-quality",
    "task-recorder": "shared-team-task-observability",
    "user-prompt-capture": "shared-memory-workflow",
...
COS_MAINTAINER_HOOK_NAME_PATTERNS = {
    ...
    "scope-marker-portability-gate": "cos-scope-taxonomy-governance",
