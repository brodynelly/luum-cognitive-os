# SCOPE: os-only
"""Portability proof for rules/bash-naming.md."""
...
ARTIFACT = REPO_ROOT / "rules/bash-naming.md"


def test_test_bash_naming_loads_from_arbitrary_project_root(tmp_path: Path) -> None:
