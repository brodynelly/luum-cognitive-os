...
Usage:
    python scripts/check-test-quality.py              # scan all test files
    python scripts/check-test-quality.py --ci         # scan only new tests in PR
    python scripts/check-test-quality.py tests/foo.py # scan specific file
"""
