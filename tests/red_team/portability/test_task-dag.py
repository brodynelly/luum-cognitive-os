# SCOPE: os-only
"""Portability proof for rules/task-dag.md."""
...
ARTIFACT = REPO_ROOT / "rules/task-dag.md"


def test_test_task_dag_loads_from_arbitrary_project_root(tmp_path: Path) -> None:
