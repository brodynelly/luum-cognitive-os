# SCOPE: os-only
"""Portability proof for rules/singularity.md."""
...
ARTIFACT = REPO_ROOT / "rules/singularity.md"


def test_test_singularity_loads_from_arbitrary_project_root(tmp_path: Path) -> None:
