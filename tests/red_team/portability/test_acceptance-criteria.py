# SCOPE: os-only
"""Portability proof for rules/acceptance-criteria.md."""
...
ARTIFACT = REPO_ROOT / "rules/acceptance-criteria.md"


def test_test_acceptance_criteria_loads_from_arbitrary_project_root(tmp_path: Path) -> None:
