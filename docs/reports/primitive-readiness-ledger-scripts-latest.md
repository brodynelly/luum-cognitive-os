...
Total scripts: 392
Roles: agentic-primitive:120, driver-specific:11, lab:23, maintainer-tool:226, migration-only:12
...
| `scripts/cos` | agentic-primitive | lifecycle | high | lifecycle-declared-consumer-candidate | candidate | shell | 1260 | keep lifecycle evidence and supported harness declarations current |
