# SCOPE: os-only
"""Portability proof for rules/cost-prediction.md."""
...
ARTIFACT = REPO_ROOT / "rules/cost-prediction.md"


def test_test_cost_prediction_loads_from_arbitrary_project_root(tmp_path: Path) -> None:
