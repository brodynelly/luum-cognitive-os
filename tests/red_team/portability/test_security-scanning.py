# SCOPE: os-only
"""Portability proof for rules/security-scanning.md."""
...
ARTIFACT = REPO_ROOT / "rules/security-scanning.md"


def test_test_security_scanning_loads_from_arbitrary_project_root(tmp_path: Path) -> None:
