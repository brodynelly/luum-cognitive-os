# SCOPE: os-only
"""Portability proof for rules/self-improvement-protocol.md."""
...
ARTIFACT = REPO_ROOT / "rules/self-improvement-protocol.md"


def test_test_self_improvement_protocol_loads_from_arbitrary_project_root(tmp_path: Path) -> None:
