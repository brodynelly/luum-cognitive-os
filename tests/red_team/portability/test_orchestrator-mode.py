# SCOPE: os-only
"""Portability proof for rules/orchestrator-mode.md."""
...
ARTIFACT = REPO_ROOT / "rules/orchestrator-mode.md"


def test_test_orchestrator_mode_loads_from_arbitrary_project_root(tmp_path: Path) -> None:
