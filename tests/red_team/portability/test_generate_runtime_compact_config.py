# SCOPE: os-only
"""Portability proof for scripts/generate_runtime_compact_config.py."""
...
ARTIFACT = REPO_ROOT / "scripts/generate_runtime_compact_config.py"


def test_generate_runtime_compact_config_safe_invocation_from_arbitrary_project_root(tmp_path: Path) -> None:
