# SCOPE: os-only
"""Portability proof for rules/memory-governance.md."""
...
ARTIFACT = REPO_ROOT / "rules/memory-governance.md"


def test_test_memory_governance_loads_from_arbitrary_project_root(tmp_path: Path) -> None:
