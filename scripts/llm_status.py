...
Usage:
    python3 scripts/llm_status.py              # pretty output, 30-day window
    python3 scripts/llm_status.py --days 7     # last 7 days
    python3 scripts/llm_status.py --json       # machine-readable
"""
