# SCOPE: os-only
"""Portability proof for rules/retry-contract.md."""
...
ARTIFACT = REPO_ROOT / "rules/retry-contract.md"


def test_test_retry_contract_loads_from_arbitrary_project_root(tmp_path: Path) -> None:
