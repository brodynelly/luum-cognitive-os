# SCOPE: os-only
"""Portability proof for rules/infra-health.md."""
...
ARTIFACT = REPO_ROOT / "rules/infra-health.md"


def test_test_infra_health_loads_from_arbitrary_project_root(tmp_path: Path) -> None:
