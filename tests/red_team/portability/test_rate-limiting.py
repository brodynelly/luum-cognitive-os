# SCOPE: os-only
"""Portability proof for rules/rate-limiting.md."""
...
ARTIFACT = REPO_ROOT / "rules/rate-limiting.md"


def test_test_rate_limiting_loads_from_arbitrary_project_root(tmp_path: Path) -> None:
