# SCOPE: os-only
"""Portability proof for rules/phase-aware-agents.md."""
...
ARTIFACT = REPO_ROOT / "rules/phase-aware-agents.md"


def test_test_phase_aware_agents_loads_from_arbitrary_project_root(tmp_path: Path) -> None:
