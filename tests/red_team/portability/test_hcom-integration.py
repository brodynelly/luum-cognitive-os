# SCOPE: os-only
"""Portability proof for rules/hcom-integration.md."""
...
ARTIFACT = REPO_ROOT / "rules/hcom-integration.md"


def test_test_hcom_integration_loads_from_arbitrary_project_root(tmp_path: Path) -> None:
