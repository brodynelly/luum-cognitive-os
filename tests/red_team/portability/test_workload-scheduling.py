# SCOPE: os-only
"""Portability proof for rules/workload-scheduling.md."""
...
ARTIFACT = REPO_ROOT / "rules/workload-scheduling.md"


def test_test_workload_scheduling_loads_from_arbitrary_project_root(tmp_path: Path) -> None:
