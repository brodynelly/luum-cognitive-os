# SCOPE: os-only
"""Portability proof for rules/result-management.md."""
...
ARTIFACT = REPO_ROOT / "rules/result-management.md"


def test_test_result_management_loads_from_arbitrary_project_root(tmp_path: Path) -> None:
