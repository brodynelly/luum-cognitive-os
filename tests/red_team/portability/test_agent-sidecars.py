# SCOPE: os-only
"""Portability proof for rules/agent-sidecars.md."""
...
ARTIFACT = REPO_ROOT / "rules/agent-sidecars.md"


def test_test_agent_sidecars_loads_from_arbitrary_project_root(tmp_path: Path) -> None:
