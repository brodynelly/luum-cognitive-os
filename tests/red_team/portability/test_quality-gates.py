# SCOPE: os-only
"""Portability proof for templates/quality-gates.md."""
...
ARTIFACT = REPO_ROOT / "templates/quality-gates.md"


def test_test_quality_gates_loads_from_arbitrary_project_root(tmp_path: Path) -> None:
