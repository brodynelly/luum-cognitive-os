# SCOPE: os-only
"""Portability proof for rules/engram-api-safety.md."""
...
ARTIFACT = REPO_ROOT / "rules/engram-api-safety.md"


def test_test_engram_api_safety_loads_from_arbitrary_project_root(tmp_path: Path) -> None:
