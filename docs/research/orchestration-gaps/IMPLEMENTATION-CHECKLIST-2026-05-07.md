...
| ADR-230 | Handoff Envelope + Cycle Deduplication | 🟡 Slice F ✅ | Envelope/dispatcher substrate plus ADR-233 inbox transport via `cos team handoff send`; cross-harness inbox contract covered. Remaining: receiver execution, external hook runner, kill-mid-dispatch chaos. | T1, T3, T4, T5, T8 done; T2/T7 pending |
