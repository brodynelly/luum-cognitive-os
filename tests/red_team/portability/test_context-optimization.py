# SCOPE: os-only
"""Portability proof for rules/context-optimization.md."""
...
ARTIFACT = REPO_ROOT / "rules/context-optimization.md"


def test_test_context_optimization_loads_from_arbitrary_project_root(tmp_path: Path) -> None:
