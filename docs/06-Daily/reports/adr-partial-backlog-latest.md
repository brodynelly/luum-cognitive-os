...
Total open partial/deferred/blocked ADRs: 122
...
| [332](../../02-Decisions/adrs/ADR-332-sia-inspired-self-improvement-benchmark-loop.md) | partial | The first implementation is a local spike with deterministic benchmark execution and proposal generation; it does not yet spawn live target/meta/feedback agents. | true |  |  |
