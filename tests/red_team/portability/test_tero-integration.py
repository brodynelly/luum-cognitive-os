# SCOPE: os-only
"""Portability proof for rules/tero-integration.md."""
...
ARTIFACT = REPO_ROOT / "rules/tero-integration.md"


def test_test_tero_integration_loads_from_arbitrary_project_root(tmp_path: Path) -> None:
