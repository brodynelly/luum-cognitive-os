# SCOPE: os-only
"""Portability proof for rules/repomix-integration.md."""
...
ARTIFACT = REPO_ROOT / "rules/repomix-integration.md"


def test_test_repomix_integration_loads_from_arbitrary_project_root(tmp_path: Path) -> None:
