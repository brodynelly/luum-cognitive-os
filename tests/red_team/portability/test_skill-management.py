# SCOPE: os-only
"""Portability proof for rules/skill-management.md."""
...
ARTIFACT = REPO_ROOT / "rules/skill-management.md"


def test_test_skill_management_loads_from_arbitrary_project_root(tmp_path: Path) -> None:
