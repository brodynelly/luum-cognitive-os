# SCOPE: os-only
"""Portability proof for rules/agent-quality.md."""
...
ARTIFACT = REPO_ROOT / "rules/agent-quality.md"


def test_test_agent_quality_loads_from_arbitrary_project_root(tmp_path: Path) -> None:
