# SCOPE: os-only
"""Portability proof for rules/RULES-COMPACT.md."""
...
ARTIFACT = REPO_ROOT / "rules/RULES-COMPACT.md"


def test_test_RULES_COMPACT_loads_from_arbitrary_project_root(tmp_path: Path) -> None:
