# SCOPE: os-only
"""Portability proof for rules/auto-rollback.md."""
...
ARTIFACT = REPO_ROOT / "rules/auto-rollback.md"


def test_test_auto_rollback_loads_from_arbitrary_project_root(tmp_path: Path) -> None:
