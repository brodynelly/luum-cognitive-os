# SCOPE: os-only
"""Portability proof for rules/scout-pattern.md."""
...
ARTIFACT = REPO_ROOT / "rules/scout-pattern.md"


def test_test_scout_pattern_loads_from_arbitrary_project_root(tmp_path: Path) -> None:
