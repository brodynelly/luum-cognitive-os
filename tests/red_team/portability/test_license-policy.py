# SCOPE: os-only
"""Portability proof for rules/license-policy.md."""
...
ARTIFACT = REPO_ROOT / "rules/license-policy.md"


def test_test_license_policy_loads_from_arbitrary_project_root(tmp_path: Path) -> None:
