...
def build_report(root: Path) -> dict[str, Any]:
    ...
    with tempfile.TemporaryDirectory(prefix="cos-portable-ai-consumer-") as td:
        ...
        status = "pass" if primitive_files and adapter_files and profile_files and registry_backed >= 20 and lifecycle_derived and no_canonical_mutation and context.get("policy", "").startswith("The `.ai` tree is a generated overlay") else "fail"
        return {
