# SCOPE: os-only
"""Portability proof for rules/split-and-resume.md."""
...
ARTIFACT = REPO_ROOT / "rules/split-and-resume.md"


def test_test_split_and_resume_loads_from_arbitrary_project_root(tmp_path: Path) -> None:
