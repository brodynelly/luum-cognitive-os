# SCOPE: os-only
"""Portability proof for templates/error-recovery.md."""
...
ARTIFACT = REPO_ROOT / "templates/error-recovery.md"


def test_test_error_recovery_loads_from_arbitrary_project_root(tmp_path: Path) -> None:
