# SCOPE: os-only
"""Portability proof for rules/agent-output-reading.md."""
...
ARTIFACT = REPO_ROOT / "rules/agent-output-reading.md"


def test_test_agent_output_reading_loads_from_arbitrary_project_root(tmp_path: Path) -> None:
