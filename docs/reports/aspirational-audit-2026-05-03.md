...
| `hooks/completion-gate.sh` | ON_DEMAND | fire_count_7d=0, registered=True, has_test=True | registered + covered by test — legit sleeper (fires when triggered) |
...
| `hooks/rate-limit-detector.sh` | ON_DEMAND | fire_count_7d=0, registered=True, has_test=True | registered + covered by test — legit sleeper (fires when triggered) |
...
| `lib/engram_claims.py` | REAL | callers=4, size_bytes=8059 | imported by 4 non-test caller(s) |
| `lib/engram_client.py` | REAL | callers=6, size_bytes=8018 | imported by 6 non-test caller(s) |
...
| `lib/engram_locks.py` | REAL | callers=4, size_bytes=9466 | imported by 4 non-test caller(s) |
...
| `lib/kpi_collector.py` | ON_DEMAND | callers=0, has_test=True, size_bytes=11669 | covered by test — legit sleeper (imported by test only) |
...
| `lib/merge_queue.py` | REAL | callers=12, size_bytes=10112 | imported by 12 non-test caller(s) |
...
| `lib/session_lifecycle.py` | REAL | callers=1, size_bytes=15641 | imported by 1 non-test caller(s) |
...
| `lib/skill_archive.py` | ON_DEMAND | callers=0, has_test=True, size_bytes=15250 | covered by test — legit sleeper (imported by test only) |
...
| `scripts/active_primitive_index.py` | ON_DEMAND | callers=0, has_test=True, size_bytes=15663 | covered by test — legit sleeper (test proves it works when called) |
...
| `scripts/adr_implementation_ledger.py` | ON_DEMAND | callers=0, has_test=True, size_bytes=13486 | covered by test — legit sleeper (test proves it works when called) |
...
| `scripts/cos-usage-report.sh` | ON_DEMAND | callers=0, has_test=True, size_bytes=9385 | covered by test — legit sleeper (test proves it works when called) |
...
| `scripts/cos-validation-capsule.sh` | ON_DEMAND | callers=0, has_test=True, size_bytes=6103 | covered by test — legit sleeper (test proves it works when called) |
...
| `scripts/cos_manifest_tier_claim_audit.py` | ON_DEMAND | callers=0, has_test=True, size_bytes=8464 | covered by test — legit sleeper (test proves it works when called) |
...
| `scripts/cos_work_inventory.py` | ON_DEMAND | callers=0, has_test=True, size_bytes=53695 | covered by test — legit sleeper (test proves it works when called) |
...
| `scripts/derived_artifact_gate.py` | ON_DEMAND | callers=0, has_test=True, size_bytes=6323 | covered by test — legit sleeper (test proves it works when called) |
...
| `scripts/generate-project-settings.sh` | ON_DEMAND | callers=0, has_test=True, size_bytes=9151 | covered by test — legit sleeper (test proves it works when called) |
...
| `scripts/lab_first_promotion_gate.py` | ON_DEMAND | callers=0, has_test=True, size_bytes=6231 | covered by test — legit sleeper (test proves it works when called) |
...
| `scripts/merge-to-main.sh` | ON_DEMAND | callers=0, has_test=True, size_bytes=2403 | covered by test — legit sleeper (test proves it works when called) |
...
| `scripts/silent_failure_audit.py` | ON_DEMAND | callers=0, has_test=True, size_bytes=15200 | covered by test — legit sleeper (test proves it works when called) |
| `scripts/skill_efficacy_report.py` | DORMANT | callers=0, size_bytes=1102 | no observable production use, no test, no on-demand marker |
...
| `scripts/smoke-agent-quota-redirect.sh` | DORMANT | callers=0, size_bytes=2646 | no observable production use, no test, no on-demand marker |
...
| `scripts/write_context_marker.py` | ON_DEMAND | callers=0, has_test=True, size_bytes=9647 | covered by test — legit sleeper (test proves it works when called) |
