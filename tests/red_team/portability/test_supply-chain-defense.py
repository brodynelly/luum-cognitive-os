# SCOPE: os-only
"""Portability proof for rules/supply-chain-defense.md."""
...
ARTIFACT = REPO_ROOT / "rules/supply-chain-defense.md"


def test_test_supply_chain_defense_loads_from_arbitrary_project_root(tmp_path: Path) -> None:
