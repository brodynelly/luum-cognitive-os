# SCOPE: os-only
"""Portability proof for rules/scope-creep-detection.md."""
...
ARTIFACT = REPO_ROOT / "rules/scope-creep-detection.md"


def test_test_scope_creep_detection_loads_from_arbitrary_project_root(tmp_path: Path) -> None:
