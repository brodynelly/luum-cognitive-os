# SCOPE: os-only
"""Portability proof for templates/adr-template.md."""
...
ARTIFACT = REPO_ROOT / "templates/adr-template.md"


def test_test_adr_template_loads_from_arbitrary_project_root(tmp_path: Path) -> None:
