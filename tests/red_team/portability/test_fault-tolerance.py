# SCOPE: os-only
"""Portability proof for rules/fault-tolerance.md."""
...
ARTIFACT = REPO_ROOT / "rules/fault-tolerance.md"


def test_test_fault_tolerance_loads_from_arbitrary_project_root(tmp_path: Path) -> None:
