...
```json
{
  "by_bucket": {
    ...
    "insufficient-metadata": 260,
    "os-only-semantic-candidate": 16,
  ...
  "by_gap": {
    ...
    "missing-consumer-availability-row": 284,
    "missing-lifecycle-row": 284,
    "no-distribution-evidence": 280
  },
  "by_prefix": {
    "hooks": 43,
    "rules": 83,
