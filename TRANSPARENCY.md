...
- The license moved from **Apache-2.0** to **FSL-1.1-MIT** before the
  ...
  [License FAQ](docs/legal/license-faq.md).
- Recovery mirrors of the pre-rewrite repository exist **off-repo** on
  ...
  [`docs/history/pre-sanitization-sha-inventory-2026-05-07.txt`](docs/history/pre-sanitization-sha-inventory-2026-05-07.txt).
...
| What | Detail |
|---|---|
| When | 2026-05-08 (timestamped report: `docs/reports/history-sanitization-20260508T061208Z.json`) |
...
| 2026-05-06 → public | FSL-1.1-MIT | [`LICENSE`](LICENSE), [License FAQ](docs/legal/license-faq.md) |
| Auto-conversion | MIT (after 2-year Change Date) | [License FAQ](docs/legal/license-faq.md) §"When does it convert" |
...
- **Operator data** — personal email and name, replaced by GitHub
  ...
  documented in [`docs/history/HISTORY-SANITIZATION-2026-05-08.md`](docs/history/HISTORY-SANITIZATION-2026-05-08.md).
...
> [`docs/legal/pre-public-readiness-checklist.md`](docs/legal/pre-public-readiness-checklist.md)
...
|---|---|---|
| Rewrite policy was frozen before execute | [`docs/history/manifest-snapshot-2026-05-07.yaml`](docs/history/manifest-snapshot-2026-05-07.yaml) | `diff manifests/history-sanitization.yaml docs/history/manifest-snapshot-2026-05-07.yaml` |
| Pre-rewrite SHAs are publicly recorded | [`docs/history/pre-sanitization-sha-inventory-2026-05-07.txt`](docs/history/pre-sanitization-sha-inventory-2026-05-07.txt) | `shasum -a 256 docs/history/pre-sanitization-sha-inventory-2026-05-07.txt` (expect `923170ead7ef9fd7c072089a699f867e111ead1be38a84ce41eb1a4023104997`) |
| Rewrite is described in operator narrative | [`docs/history/HISTORY-SANITIZATION-2026-05-08.md`](docs/history/HISTORY-SANITIZATION-2026-05-08.md) | open and read |
| Runtime report (replacement counts, blobs/commits rewritten) | [`docs/reports/history-sanitization-20260508T061208Z.json`](docs/reports/history-sanitization-20260508T061208Z.json) | `jq '.summary' docs/reports/history-sanitization-20260508T061208Z.json` |
| License transition strings preserved | [`LICENSE`](LICENSE), [`NOTICE`](NOTICE), [License FAQ](docs/legal/license-faq.md) | `grep -E 'Apache\|FSL-1\.1-MIT' LICENSE NOTICE docs/legal/license-faq.md` |
| SBOM | [`sbom.json`](sbom.json) | `shasum -a 256 sbom.json` |
| Policy ADR | `docs/adrs/ADR-218-history-sanitization-toolchain.md` | open and read |
...
# Expect: only matches inside docs/legal/pre-public-readiness-checklist.md
...
head -5 docs/history/pre-sanitization-sha-inventory-2026-05-07.txt | \
  awk '{print $1}' | \
...
at [`docs/security/verify-public-release.md`](docs/security/verify-public-release.md).
