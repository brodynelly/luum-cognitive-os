...
- Capabilities: 729
- Findings: 153
- Mapping weights: {'aligned': 527, 'missing': 0, 'overexposed': 0, 'partial': 204, 'stale': 0, 'unverified': 1254}
...
| harness_projection | ok | `manifests/harness-projection.yaml` | `{"implemented": 2, "planned": 6, "total": 8, "unsupported": 0}` |
...
| readiness:scripts | ok | `docs/reports/primitive-readiness-ledger-scripts-latest.json` | `{"agentic_primitives_without_lifecycle": 0, "confidence": {"high": 137, "medium": 179}, "consumer_accessibility": {"install-profile-managed": 19, "lifecycle-declared-consumer-candidate": 49, "lifecycle-declared-maintainer": 38, "skill-refer` |
