...
Usage:
    python3 scripts/parity-harness.py --tasks docs/benchmarks/parity-smoke.yaml
    python3 scripts/parity-harness.py --tasks ... --report docs/benchmarks/out.md
    python3 scripts/parity-harness.py --tasks ... --only-qwen    # debug mode
    python3 scripts/parity-harness.py --tasks ... --dry-run      # no providers
