...
| `skills/code-review/SKILL.md` | project-extension | default | medium | repo-skill-not-projectable |  | 39 | add lifecycle/package/projection metadata or keep SO-local |
| `skills/cognitive-os-init/SKILL.md` | compatibility-wrapper | usage:script-hook | high | repo-skill-not-projectable |  | 43 | add lifecycle/package/projection metadata or keep SO-local |
...
| `skills/doc-review-personas/SKILL.md` | compatibility-wrapper | usage:script-hook | high | repo-skill-not-projectable |  | 9 | add lifecycle/package/projection metadata or keep SO-local |
...
| `skills/dogfood-score/SKILL.md` | compatibility-wrapper | usage:script-hook | high | repo-skill-not-projectable |  | 18 | add lifecycle/package/projection metadata or keep SO-local |
| `skills/domain-model/SKILL.md` | compatibility-wrapper | usage:script-hook | high | repo-skill-not-projectable |  | 7 | add lifecycle/package/projection metadata or keep SO-local |
| `skills/eval-repo/SKILL.md` | compatibility-wrapper | usage:script-hook | high | repo-skill-not-projectable |  | 5 | add lifecycle/package/projection metadata or keep SO-local |
| `skills/experimental/SKILL.md` | lab | heuristic:path | medium | repo-skill-not-projectable |  | 47 | add lifecycle/package/projection metadata or keep SO-local |
| `skills/experimental/auto-bash-agent-bash-9c6b89/SKILL.md` | lab | heuristic:path | medium | repo-skill-not-projectable |  | 0 | add lifecycle/package/projection metadata or keep SO-local |
| `skills/generate-changelog/SKILL.md` | so-maintainer | heuristic:text | medium | repo-skill-not-projectable |  | 10 | add lifecycle/package/projection metadata or keep SO-local |
...
| `skills/hook-timing/SKILL.md` | compatibility-wrapper | usage:script-hook | high | repo-skill-not-projectable |  | 40 | add lifecycle/package/projection metadata or keep SO-local |
...
| `skills/invariant-check/SKILL.md` | compatibility-wrapper | usage:script-hook | high | repo-skill-not-projectable |  | 9 | add lifecycle/package/projection metadata or keep SO-local |
...
| `skills/security-red-team/SKILL.md` | compatibility-wrapper | usage:script-hook | high | repo-skill-not-projectable |  | 21 | add lifecycle/package/projection metadata or keep SO-local |
| `skills/session-backlog/SKILL.md` | compatibility-wrapper | usage:script-hook | high | repo-skill-not-projectable |  | 35 | add lifecycle/package/projection metadata or keep SO-local |
| `skills/session-manager/SKILL.md` | so-maintainer | heuristic:text | medium | repo-skill-not-projectable |  | 9 | add lifecycle/package/projection metadata or keep SO-local |
