# SCOPE: os-only
"""Portability proof for rules/prompt-quality.md."""
...
ARTIFACT = REPO_ROOT / "rules/prompt-quality.md"


def test_test_prompt_quality_loads_from_arbitrary_project_root(tmp_path: Path) -> None:
