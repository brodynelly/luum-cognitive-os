# SCOPE: os-only
"""Portability proof for rules/dynamic-tool-creation.md."""
...
ARTIFACT = REPO_ROOT / "rules/dynamic-tool-creation.md"


def test_test_dynamic_tool_creation_loads_from_arbitrary_project_root(tmp_path: Path) -> None:
