# SCOPE: os-only
"""Portability proof for rules/definition-of-done.md."""
...
ARTIFACT = REPO_ROOT / "rules/definition-of-done.md"


def test_test_definition_of_done_loads_from_arbitrary_project_root(tmp_path: Path) -> None:
