# SCOPE: os-only
"""Portability proof for rules/closed-loop-prompts.md."""
...
ARTIFACT = REPO_ROOT / "rules/closed-loop-prompts.md"


def test_test_closed_loop_prompts_loads_from_arbitrary_project_root(tmp_path: Path) -> None:
