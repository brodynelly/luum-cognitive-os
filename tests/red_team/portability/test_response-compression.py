# SCOPE: os-only
"""Portability proof for rules/response-compression.md."""
...
ARTIFACT = REPO_ROOT / "rules/response-compression.md"


def test_test_response_compression_loads_from_arbitrary_project_root(tmp_path: Path) -> None:
