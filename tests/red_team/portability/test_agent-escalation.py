# SCOPE: os-only
"""Portability proof for rules/agent-escalation.md."""
...
ARTIFACT = REPO_ROOT / "rules/agent-escalation.md"


def test_test_agent_escalation_loads_from_arbitrary_project_root(tmp_path: Path) -> None:
