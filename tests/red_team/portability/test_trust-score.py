# SCOPE: os-only
"""Portability proof for rules/trust-score.md."""
...
ARTIFACT = REPO_ROOT / "rules/trust-score.md"


def test_test_trust_score_loads_from_arbitrary_project_root(tmp_path: Path) -> None:
