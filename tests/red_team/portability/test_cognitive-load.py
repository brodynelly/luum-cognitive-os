# SCOPE: os-only
"""Portability proof for rules/cognitive-load.md."""
...
ARTIFACT = REPO_ROOT / "rules/cognitive-load.md"


def test_test_cognitive_load_loads_from_arbitrary_project_root(tmp_path: Path) -> None:
