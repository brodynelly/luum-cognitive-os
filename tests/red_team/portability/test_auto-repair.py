# SCOPE: os-only
"""Portability proof for rules/auto-repair.md."""
...
ARTIFACT = REPO_ROOT / "rules/auto-repair.md"


def test_test_auto_repair_loads_from_arbitrary_project_root(tmp_path: Path) -> None:
