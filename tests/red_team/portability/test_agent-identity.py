# SCOPE: os-only
"""Portability proof for rules/agent-identity.md."""
...
ARTIFACT = REPO_ROOT / "rules/agent-identity.md"


def test_test_agent_identity_loads_from_arbitrary_project_root(tmp_path: Path) -> None:
