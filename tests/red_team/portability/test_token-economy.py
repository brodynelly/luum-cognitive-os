# SCOPE: os-only
"""Portability proof for rules/token-economy.md."""
...
ARTIFACT = REPO_ROOT / "rules/token-economy.md"


def test_test_token_economy_loads_from_arbitrary_project_root(tmp_path: Path) -> None:
