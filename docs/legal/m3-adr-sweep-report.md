...
`docs/adrs/ADR-228-retry-contract-and-cost-budget.md` opens with two
...
2. Captured every `ADR-NNN` token and verified the target file exists in
   `docs/adrs/`. Since the directory uses both slugged
...
| 227 | Shadow-Git Checkpoint Substrate | Accepted | 2025 | YES | YES | LOW: lists `multi-agent-orchestration-prior-art-2026-05-06.md` as a bare filename — should be the full `docs/research/` path for symmetry with siblings. |
...
*Generated by the M3 ADR sweep agent. Read-only over `docs/adrs/`. No
