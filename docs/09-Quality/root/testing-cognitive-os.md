...
3. **Phase 3**: ~~Build custom Engram persistence test harness~~ **DONE** — `tests/integration/test_engram_persistence.py` covers 19 real engram tests using the `real_engram` fixture (no MagicMock; backed by a real SQLite DB).
