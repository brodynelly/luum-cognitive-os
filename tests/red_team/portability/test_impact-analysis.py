# SCOPE: os-only
"""Portability proof for rules/impact-analysis.md."""
...
ARTIFACT = REPO_ROOT / "rules/impact-analysis.md"


def test_test_impact_analysis_loads_from_arbitrary_project_root(tmp_path: Path) -> None:
