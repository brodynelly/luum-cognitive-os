...
(`_hook_count: 33`). Enable by copying that profile into `.claude/settings.json`
...
The OS fires hooks on every tool call. At lean tier that is ~33 fires; even
