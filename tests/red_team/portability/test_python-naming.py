# SCOPE: os-only
"""Portability proof for rules/python-naming.md."""
...
ARTIFACT = REPO_ROOT / "rules/python-naming.md"


def test_test_python_naming_loads_from_arbitrary_project_root(tmp_path: Path) -> None:
