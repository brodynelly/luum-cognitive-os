...
| `consumer_projection` | Temporary projects generated by `scripts/cos_init.py --default --harness claude/codex` | Proof that hooks, skills, and rules are actually projected into consumer projects. |
