# SCOPE: os-only
"""Portability proof for rules/trailofbits-skills.md."""
...
ARTIFACT = REPO_ROOT / "rules/trailofbits-skills.md"


def test_test_trailofbits_skills_loads_from_arbitrary_project_root(tmp_path: Path) -> None:
