# SCOPE: os-only
"""Portability proof for rules/agent-security.md."""
...
ARTIFACT = REPO_ROOT / "rules/agent-security.md"


def test_test_agent_security_loads_from_arbitrary_project_root(tmp_path: Path) -> None:
