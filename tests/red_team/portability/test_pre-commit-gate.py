# SCOPE: os-only
"""Portability proof for rules/pre-commit-gate.md."""
...
ARTIFACT = REPO_ROOT / "rules/pre-commit-gate.md"


def test_test_pre_commit_gate_loads_from_arbitrary_project_root(tmp_path: Path) -> None:
