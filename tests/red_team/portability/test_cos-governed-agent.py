# SCOPE: os-only
"""Portability proof for scripts/cos-governed-agent.sh."""
...
ARTIFACT = REPO_ROOT / "scripts/cos-governed-agent.sh"


def test_cos_governed_agent_runs_from_arbitrary_project_root(tmp_path: Path) -> None:
