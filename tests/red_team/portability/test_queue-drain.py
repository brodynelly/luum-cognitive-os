# SCOPE: os-only
"""Portability proof for rules/queue-drain.md."""
...
ARTIFACT = REPO_ROOT / "rules/queue-drain.md"


def test_test_queue_drain_loads_from_arbitrary_project_root(tmp_path: Path) -> None:
