# SCOPE: os-only
"""Portability proof for rules/context-management.md."""
...
ARTIFACT = REPO_ROOT / "rules/context-management.md"


def test_test_context_management_loads_from_arbitrary_project_root(tmp_path: Path) -> None:
