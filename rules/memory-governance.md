...
Declare typed memory governance policies (lifecycle decay, retention, mid-task tool budgets) so consumers of the memory layer can rely on uniform contract enforcement.
