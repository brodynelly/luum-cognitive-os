# SCOPE: os-only
"""Portability proof for rules/consequence-system.md."""
...
ARTIFACT = REPO_ROOT / "rules/consequence-system.md"


def test_test_consequence_system_loads_from_arbitrary_project_root(tmp_path: Path) -> None:
