# SCOPE: os-only
"""Portability proof for rules/auto-skill-generation.md."""
...
ARTIFACT = REPO_ROOT / "rules/auto-skill-generation.md"


def test_test_auto_skill_generation_loads_from_arbitrary_project_root(tmp_path: Path) -> None:
