# SCOPE: os-only
"""Portability proof for rules/model-compatibility.md."""
...
ARTIFACT = REPO_ROOT / "rules/model-compatibility.md"


def test_test_model_compatibility_loads_from_arbitrary_project_root(tmp_path: Path) -> None:
