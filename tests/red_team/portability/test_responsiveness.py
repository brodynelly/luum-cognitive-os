# SCOPE: os-only
"""Portability proof for rules/responsiveness.md."""
...
ARTIFACT = REPO_ROOT / "rules/responsiveness.md"


def test_test_responsiveness_loads_from_arbitrary_project_root(tmp_path: Path) -> None:
