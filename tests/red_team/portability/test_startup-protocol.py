# SCOPE: os-only
"""Portability proof for rules/startup-protocol.md."""
...
ARTIFACT = REPO_ROOT / "rules/startup-protocol.md"


def test_test_startup_protocol_loads_from_arbitrary_project_root(tmp_path: Path) -> None:
