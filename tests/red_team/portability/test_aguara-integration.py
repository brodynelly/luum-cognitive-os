# SCOPE: os-only
"""Portability proof for rules/aguara-integration.md."""
...
ARTIFACT = REPO_ROOT / "rules/aguara-integration.md"


def test_test_aguara_integration_loads_from_arbitrary_project_root(tmp_path: Path) -> None:
