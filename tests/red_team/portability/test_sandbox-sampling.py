# SCOPE: os-only
"""Portability proof for rules/sandbox-sampling.md."""
...
ARTIFACT = REPO_ROOT / "rules/sandbox-sampling.md"


def test_test_sandbox_sampling_loads_from_arbitrary_project_root(tmp_path: Path) -> None:
