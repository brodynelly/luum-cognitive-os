...
- status: `planned`
- proof level: `None`
- projection mode: `kiro-steering-hooks-mcp-investigation`

## Settings paths

- `.kiro/steering`
- `agent configuration file (exact project path under investigation)`

## Rule

Read `.ai/profiles/kiro.json` for declared fidelity before projecting primitives into this host.
