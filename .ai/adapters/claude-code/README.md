# Claude Code portable `.ai` adapter
...
- harness id: `claude`
- status: `implemented`
- proof level: `native-lifecycle`
- projection mode: `native-settings`
...
Read `.ai/profiles/claude.json` for declared fidelity before projecting primitives into this host.
