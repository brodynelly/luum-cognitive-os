# SCOPE: os-only
"""Portability proof for rules/broken-window-policy.md."""
...
ARTIFACT = REPO_ROOT / "rules/broken-window-policy.md"


def test_test_broken_window_policy_loads_from_arbitrary_project_root(tmp_path: Path) -> None:
