# SCOPE: os-only
"""Portability proof for rules/infra-intent.md."""
...
ARTIFACT = REPO_ROOT / "rules/infra-intent.md"


def test_test_infra_intent_loads_from_arbitrary_project_root(tmp_path: Path) -> None:
