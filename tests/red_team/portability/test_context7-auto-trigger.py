# SCOPE: os-only
"""Portability proof for rules/context7-auto-trigger.md."""
...
ARTIFACT = REPO_ROOT / "rules/context7-auto-trigger.md"


def test_test_context7_auto_trigger_loads_from_arbitrary_project_root(tmp_path: Path) -> None:
