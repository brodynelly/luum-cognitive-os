# SCOPE: os-only
"""Portability proof for rules/decision-depth-gate.md."""
...
ARTIFACT = REPO_ROOT / "rules/decision-depth-gate.md"


def test_test_decision_depth_gate_loads_from_arbitrary_project_root(tmp_path: Path) -> None:
