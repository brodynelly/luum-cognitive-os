# SCOPE: os-only
"""Portability proof for rules/agent-customization.md."""
...
ARTIFACT = REPO_ROOT / "rules/agent-customization.md"


def test_test_agent_customization_loads_from_arbitrary_project_root(tmp_path: Path) -> None:
