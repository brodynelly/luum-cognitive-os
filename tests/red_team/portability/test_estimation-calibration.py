# SCOPE: os-only
"""Portability proof for rules/estimation-calibration.md."""
...
ARTIFACT = REPO_ROOT / "rules/estimation-calibration.md"


def test_test_estimation_calibration_loads_from_arbitrary_project_root(tmp_path: Path) -> None:
