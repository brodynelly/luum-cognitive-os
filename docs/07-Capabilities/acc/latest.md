...
| harness_coverage | ok | `docs/reports/primitive-harness-coverage-latest.json` | `{"by_family": {"hooks": 266, "rules": 120, "scripts": 541, "skills": 101, "templates": 22}, "by_scope": {"both": 580, "os-only": 406, "project": 64}, "gap_policies": {"acceptable-claude-only": 4, "acceptable-codex-limited-tool-events": 6, "` |
...
| readiness:hooks | ok | `docs/reports/primitive-readiness-ledger-hooks-latest.json` | `{"confidence": {"high": 173, "medium": 93}, "consumer_accessibility": {"lifecycle-declared-consumer-candidate": 1, "lifecycle-declared-maintainer": 155, "projected-consumer-surface": 17, "so-local-only": 93}, "roles": {"driver-specific": 23` |
| readiness:rules | ok | `docs/reports/primitive-readiness-ledger-rules-latest.json` | `{"confidence": {"medium": 120}, "consumer_accessibility": {"lifecycle-declared-maintainer": 1, "so-local-only": 119}, "roles": {"context-only": 6, "doctrine": 4, "driver-specific": 52, "hook-enforced": 47, "lab": 11}, "total": 120, "without` |
