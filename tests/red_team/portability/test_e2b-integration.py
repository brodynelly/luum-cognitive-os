# SCOPE: os-only
"""Portability proof for rules/e2b-integration.md."""
...
ARTIFACT = REPO_ROOT / "rules/e2b-integration.md"


def test_test_e2b_integration_loads_from_arbitrary_project_root(tmp_path: Path) -> None:
