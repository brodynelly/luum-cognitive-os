# SCOPE: os-only
"""Portability proof for rules/llm-dispatch.md."""
...
ARTIFACT = REPO_ROOT / "rules/llm-dispatch.md"


def test_test_llm_dispatch_loads_from_arbitrary_project_root(tmp_path: Path) -> None:
