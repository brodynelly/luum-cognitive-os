# SCOPE: os-only
"""Portability proof for rules/model-routing.md."""
...
ARTIFACT = REPO_ROOT / "rules/model-routing.md"


def test_test_model_routing_loads_from_arbitrary_project_root(tmp_path: Path) -> None:
