# SCOPE: os-only
"""Portability proof for rules/content-policy.md."""
...
ARTIFACT = REPO_ROOT / "rules/content-policy.md"


def test_test_content_policy_loads_from_arbitrary_project_root(tmp_path: Path) -> None:
