# SCOPE: os-only
"""Portability proof for rules/performance-monitoring.md."""
...
ARTIFACT = REPO_ROOT / "rules/performance-monitoring.md"


def test_test_performance_monitoring_loads_from_arbitrary_project_root(tmp_path: Path) -> None:
