# SCOPE: os-only
"""Portability proof for rules/credential-management.md."""
...
ARTIFACT = REPO_ROOT / "rules/credential-management.md"


def test_test_credential_management_loads_from_arbitrary_project_root(tmp_path: Path) -> None:
