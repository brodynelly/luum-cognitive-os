# SCOPE: os-only
"""Portability proof for rules/agent-kpis.md."""
...
ARTIFACT = REPO_ROOT / "rules/agent-kpis.md"


def test_test_agent_kpis_loads_from_arbitrary_project_root(tmp_path: Path) -> None:
