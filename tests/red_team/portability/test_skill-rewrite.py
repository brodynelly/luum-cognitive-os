# SCOPE: os-only
"""Portability proof for rules/skill-rewrite.md."""
...
ARTIFACT = REPO_ROOT / "rules/skill-rewrite.md"


def test_test_skill_rewrite_loads_from_arbitrary_project_root(tmp_path: Path) -> None:
