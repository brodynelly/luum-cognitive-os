...
Usage
-----
    python3 scripts/cos-test-quality-audit.py              # scan + write JSONL
    python3 scripts/cos-test-quality-audit.py --summary    # scan + print table
    python3 scripts/cos-test-quality-audit.py --file tests/unit/foo.py
    python3 scripts/cos-test-quality-audit.py --help
"""
