# SCOPE: os-only
"""Portability proof for rules/non-blocking-retry.md."""
...
ARTIFACT = REPO_ROOT / "rules/non-blocking-retry.md"


def test_test_non_blocking_retry_loads_from_arbitrary_project_root(tmp_path: Path) -> None:
