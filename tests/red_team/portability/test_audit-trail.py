# SCOPE: os-only
"""Portability proof for rules/audit-trail.md."""
...
ARTIFACT = REPO_ROOT / "rules/audit-trail.md"


def test_test_audit_trail_loads_from_arbitrary_project_root(tmp_path: Path) -> None:
