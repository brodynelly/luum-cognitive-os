#!/usr/bin/env python3
# SCOPE: os-only
"""update-readme-badges.py — Generate shields.io badge JSON endpoints and update README.
...
Usage:
    uv run python3 scripts/update-readme-badges.py
    python3 scripts/update-readme-badges.py  (when deps already installed)
"""
...
def main() -> int:
    print("update-readme-badges: loading metrics...")
