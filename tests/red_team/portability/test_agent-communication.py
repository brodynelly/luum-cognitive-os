# SCOPE: os-only
"""Portability proof for rules/agent-communication.md."""
...
ARTIFACT = REPO_ROOT / "rules/agent-communication.md"


def test_test_agent_communication_loads_from_arbitrary_project_root(tmp_path: Path) -> None:
