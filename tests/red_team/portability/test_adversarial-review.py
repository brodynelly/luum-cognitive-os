# SCOPE: os-only
"""Portability proof for rules/adversarial-review.md."""
...
ARTIFACT = REPO_ROOT / "rules/adversarial-review.md"


def test_test_adversarial_review_loads_from_arbitrary_project_root(tmp_path: Path) -> None:
