# Aspirational Audit — 2026-05-05

## Summary

| Metric | Value |
|--------|-------|
| Total components | 914 |
| REAL | 156 |
| DORMANT | 180 |
| ASPIRATIONAL | 36 |
| METADATA | 58 |
| DORMANT + ASPIRATIONAL ratio | 23.6% |
...
| `hooks/adaptive-bypass.sh` | ON_DEMAND | fire_count_7d=0, registered=True, has_test=True | registered + covered by test — legit sleeper (fires when triggered) |
...
| `hooks/assumption-tracker.sh` | ON_DEMAND | fire_count_7d=0, registered=True, has_test=True | registered + covered by test — legit sleeper (fires when triggered) |
| `hooks/audit-id-enricher.sh` | ON_DEMAND | fire_count_7d=0, registered=True, has_test=True | registered + covered by test — legit sleeper (fires when triggered) |
...
| `hooks/auto-repair-dispatcher.sh` | ON_DEMAND | fire_count_7d=0, registered=True, has_test=True | registered + covered by test — legit sleeper (fires when triggered) |
| `hooks/auto-rollback-trigger.sh` | ON_DEMAND | fire_count_7d=0, registered=True, has_test=True | registered + covered by test — legit sleeper (fires when triggered) |
...
| `hooks/blast-radius.sh` | ON_DEMAND | fire_count_7d=0, registered=True, has_test=True | registered + covered by test — legit sleeper (fires when triggered) |
| `hooks/claim-validator.sh` | ON_DEMAND | fire_count_7d=0, registered=True, has_test=True | registered + covered by test — legit sleeper (fires when triggered) |
| `hooks/clarification-gate.sh` | ON_DEMAND | fire_count_7d=0, registered=True, has_test=True | registered + covered by test — legit sleeper (fires when triggered) |
...
| `hooks/confidence-gate.sh` | ON_DEMAND | fire_count_7d=0, registered=True, has_test=True | registered + covered by test — legit sleeper (fires when triggered) |
...
| `hooks/engram-obsidian-export-on-stop.sh` | ON_DEMAND | fire_count_7d=0, registered=True, has_test=True | registered + covered by test — legit sleeper (fires when triggered) |
...
| `hooks/native-agent-heartbeat.sh` | ON_DEMAND | fire_count_7d=0, registered=True, has_test=True | registered + covered by test — legit sleeper (fires when triggered) |
...
| `hooks/predev-completeness-check.sh` | ON_DEMAND | fire_count_7d=0, registered=True, has_test=True | registered + covered by test — legit sleeper (fires when triggered) |
...
| `hooks/scope-proportionality.sh` | ON_DEMAND | fire_count_7d=0, registered=True, has_test=True | registered + covered by test — legit sleeper (fires when triggered) |
...
| `hooks/skill-failure-monitor.sh` | ON_DEMAND | fire_count_7d=0, registered=True, has_test=True | registered + covered by test — legit sleeper (fires when triggered) |
...
| `hooks/token-budget-monitor.sh` | ON_DEMAND | fire_count_7d=0, registered=True, has_test=True | registered + covered by test — legit sleeper (fires when triggered) |
...
| `lib/checkpoint_manager.py` | ON_DEMAND | callers=0, has_test=True, size_bytes=17752 | covered by test — legit sleeper (imported by test only) |
...
| `lib/project_paths.py` | REAL | callers=15, size_bytes=1228 | imported by 15 non-test caller(s) |
...
| `lib/queue_advisor.py` | ON_DEMAND | callers=0, has_test=True, size_bytes=27198 | covered by test — legit sleeper (imported by test only) |
...
| `lib/script_io.py` | REAL | callers=28, size_bytes=2690 | imported by 28 non-test caller(s) |
...
| `lib/skill_router.py` | REAL | callers=1, size_bytes=46141 | imported by 1 non-test caller(s) |
...
| `scripts/acc_pipeline.py` | ON_DEMAND | callers=0, has_test=True, size_bytes=57395 | covered by test — legit sleeper (test proves it works when called) |
...
| `scripts/adr_implementation_ledger.py` | ON_DEMAND | callers=0, has_test=True, size_bytes=20832 | covered by test — legit sleeper (test proves it works when called) |
...
| `scripts/apply-efficiency-profile.sh` | ON_DEMAND | callers=0, has_test=True, size_bytes=13248 | covered by test — legit sleeper (test proves it works when called) |
...
| `scripts/aspirational_audit.py` | ON_DEMAND | callers=0, on_demand_marker=True, size_bytes=35217 | @on-demand marker — legit rarely-invoked script |
...
| `scripts/auto_tune_routing.py` | DORMANT | callers=0, size_bytes=1170 | no observable production use, no test, no on-demand marker |
| `scripts/backfill_cost_events.py` | DORMANT | callers=0, size_bytes=2862 | no observable production use, no test, no on-demand marker |
...
| `scripts/cos-ci-local.sh` | ON_DEMAND | callers=0, has_test=True, size_bytes=14922 | covered by test — legit sleeper (test proves it works when called) |
| `scripts/cos-claims.sh` | DORMANT | callers=0, size_bytes=5176 | no observable production use, no test, no on-demand marker |
| `scripts/cos-cloud-worker-bootstrap.sh` | ON_DEMAND | callers=0, on_demand_marker=True, size_bytes=1439 | @on-demand marker — legit rarely-invoked script |
...
| `scripts/cos-flow-register.sh` | ON_DEMAND | callers=0, has_test=True, size_bytes=191 | covered by test — legit sleeper (test proves it works when called) |
...
| `scripts/cos-paperclip-local.sh` | ON_DEMAND | callers=0, has_test=True, size_bytes=9489 | covered by test — legit sleeper (test proves it works when called) |
...
| `scripts/cos-startup-recover.sh` | ON_DEMAND | callers=0, has_test=True, size_bytes=3201 | covered by test — legit sleeper (test proves it works when called) |
...
| `scripts/cos-validation-break.sh` | ON_DEMAND | callers=0, has_test=True, size_bytes=5166 | covered by test — legit sleeper (test proves it works when called) |
| `scripts/cos-validation-capsule.sh` | REAL | writes_jsonl=True, size_bytes=7418 | writes to an existing metrics JSONL file |
...
| `scripts/cos-valkey-local.sh` | ON_DEMAND | callers=0, has_test=True, size_bytes=9162 | covered by test — legit sleeper (test proves it works when called) |
...
| `scripts/cos_executor.py` | ON_DEMAND | callers=0, has_test=True, size_bytes=14618 | covered by test — legit sleeper (test proves it works when called) |
| `scripts/cos_false_positive_ledger.py` | ON_DEMAND | callers=0, has_test=True, size_bytes=4757 | covered by test — legit sleeper (test proves it works when called) |
...
| `scripts/cos_friction_report.py` | ON_DEMAND | callers=0, has_test=True, size_bytes=2243 | covered by test — legit sleeper (test proves it works when called) |
| `scripts/cos_governance_roi.py` | ON_DEMAND | callers=0, has_test=True, size_bytes=10156 | covered by test — legit sleeper (test proves it works when called) |
...
| `scripts/cos_init.py` | ON_DEMAND | callers=0, has_test=True, size_bytes=72312 | covered by test — legit sleeper (test proves it works when called) |
...
| `scripts/cos_watch.py` | ON_DEMAND | callers=0, has_test=True, size_bytes=11945 | covered by test — legit sleeper (test proves it works when called) |
...
| `scripts/cos_work_inventory.py` | ON_DEMAND | callers=0, has_test=True, size_bytes=53735 | covered by test — legit sleeper (test proves it works when called) |
...
| `scripts/cost_predict.py` | ON_DEMAND | callers=0, has_test=True, size_bytes=2245 | covered by test — legit sleeper (test proves it works when called) |
...
| `scripts/demo-governance.sh` | DORMANT | callers=0, size_bytes=12835 | no observable production use, no test, no on-demand marker |
...
| `scripts/hook-timing-wrapper.sh` | ON_DEMAND | callers=0, has_test=True, size_bytes=17181 | covered by test — legit sleeper (test proves it works when called) |
...
| `scripts/hook_timing_report.py` | DORMANT | callers=0, size_bytes=16556 | no observable production use, no test, no on-demand marker |
...
| `scripts/install-git-hooks.sh` | DORMANT | callers=0, size_bytes=1199 | no observable production use, no test, no on-demand marker |
...
| `scripts/merge-to-main.sh` | ON_DEMAND | callers=0, has_test=True, size_bytes=2716 | covered by test — legit sleeper (test proves it works when called) |
| `scripts/metrics_tamper_audit.py` | ON_DEMAND | callers=0, has_test=True, size_bytes=2022 | covered by test — legit sleeper (test proves it works when called) |
...
| `scripts/orchestrator_claim_gate.py` | ON_DEMAND | callers=0, has_test=True, size_bytes=13728 | covered by test — legit sleeper (test proves it works when called) |
...
| `scripts/primitive_family_readiness_ledger.py` | ON_DEMAND | callers=0, has_test=True, size_bytes=15094 | covered by test — legit sleeper (test proves it works when called) |
...
| `scripts/primitive_gap_snapshot.py` | ON_DEMAND | callers=0, has_test=True, size_bytes=19191 | covered by test — legit sleeper (test proves it works when called) |
| `scripts/primitive_lifecycle.py` | ON_DEMAND | callers=0, has_test=True, size_bytes=15699 | covered by test — legit sleeper (test proves it works when called) |
...
| `scripts/pytest-with-summary.sh` | ON_DEMAND | callers=0, has_test=True, size_bytes=20535 | covered by test — legit sleeper (test proves it works when called) |
...
| `scripts/run-runtime-benchmark.sh` | DORMANT | callers=0, size_bytes=2180 | no observable production use, no test, no on-demand marker |
...
| `scripts/runtime_benchmark_report.py` | DORMANT | callers=0, size_bytes=1047 | no observable production use, no test, no on-demand marker |
...
| `scripts/session_start_budget.py` | ON_DEMAND | callers=0, has_test=True, size_bytes=9571 | covered by test — legit sleeper (test proves it works when called) |
...
| `scripts/smoke-agent-quota-advisor.sh` | DORMANT | callers=0, size_bytes=4127 | no observable production use, no test, no on-demand marker |
...
| `scripts/so-reaper.sh` | ON_DEMAND | callers=0, has_test=True, size_bytes=11839 | covered by test — legit sleeper (test proves it works when called) |
...
| `scripts/so_session_watchdog.py` | ON_DEMAND | callers=0, has_test=True, size_bytes=13243 | covered by test — legit sleeper (test proves it works when called) |
...
| `scripts/statusline-coverage.sh` | ON_DEMAND | callers=0, on_demand_marker=True, size_bytes=3216 | @on-demand marker — legit rarely-invoked script |
