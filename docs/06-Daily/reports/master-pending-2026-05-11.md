...
sources:
  - .cognitive-os/sessions/default/backlog.md (promoted as docs/06-Daily/reports/session-backlog-latest.md)
  - docs/06-Daily/reports/radar-2026-05-08-implementation-tracker.md
  - docs/06-Daily/reports/p2-plan-reconciliation-2026-05-10.md
  - docs/06-Daily/reports/p3-plan-triage-2026-05-10.md
  - docs/06-Daily/reports/p4-active-tasks-prune-2026-05-11.md
  ...
  - docs/06-Daily/reports/pending-plans-audit-2026-04-30.md
...
- **"Full noisy raw backlog?"** → [`docs/06-Daily/reports/session-backlog-latest.md`](session-backlog-latest.md) (promoted from `cos_session_backlog.py` output).
...
Canonical tracker: [`docs/06-Daily/reports/radar-2026-05-08-implementation-tracker.md`](radar-2026-05-08-implementation-tracker.md).
...
Canonical: [`docs/06-Daily/reports/radar-2026-05-08-implementation-tracker.md` §Post-v0.28.0 follow-ups](radar-2026-05-08-implementation-tracker.md).
...
| T-H4 BPF compile | Strict seccomp BPF profile generation | ⏸ parked (requires workload smokes per `docs/09-Quality/security/bwrap-seccomp-threat-model.md`) |
| T-public-launch | T-0 GitHub visibility flip | ⏸ operator decision (`docs/05-Methodology/runbooks/public-launch-day.md`) |
...
Canonical: [`docs/06-Daily/reports/p2-plan-reconciliation-2026-05-10.md`](p2-plan-reconciliation-2026-05-10.md).
...
Canonical: [`docs/06-Daily/reports/p3-plan-triage-2026-05-10.md`](p3-plan-triage-2026-05-10.md).
...
| `features/workflow-engine.md` | TOMBSTONE (by coexistence) | `.cognitive-os/workflows/` + `docs/08-References/root/adw-patterns.md` + ADR-036 already deliver. ADR-tombstone recommended |
...
Canonical: [`docs/06-Daily/reports/p4-active-tasks-prune-2026-05-11.md`](p4-active-tasks-prune-2026-05-11.md).
...
| Path | Use |
|---|---|
| [`docs/06-Daily/reports/session-backlog-latest.md`](session-backlog-latest.md) | Raw 212-item backlog from `cos_session_backlog.py` (was gitignored; now promoted) |
| [`docs/06-Daily/reports/reduction-backlog-latest.md`](reduction-backlog-latest.md) | Reduction Sprint Backlog |
| [`docs/06-Daily/reports/primitive-readiness-lifecycle-backlog-scripts-latest.md`](primitive-readiness-lifecycle-backlog-scripts-latest.md) | Primitive readiness lifecycle |
...
|---|---|---|
| `features/workflow-engine.md` | Next available ADR-tombstone number | Capability already delivered by `.cognitive-os/workflows/` + `docs/08-References/root/adw-patterns.md` + ADR-036 |

## 10. 31 newly triaged plans (Opus discovery 2026-05-11)

Canonical: [`docs/06-Daily/reports/plans-discovery-triage-2026-05-11.md`](plans-discovery-triage-2026-05-11.md).
...
- `pending-attack-plan-2026-05-02.md` (report, not plan — relocate to `docs/06-Daily/reports/archive/`)
...
Canonical detail: [`docs/06-Daily/reports/plans-discovery-triage-2026-05-11.md` §2](plans-discovery-triage-2026-05-11.md).
...
- **This doc is append-only per session-date.** New triage waves add a new `docs/06-Daily/reports/master-pending-YYYY-MM-DD.md`; the prior date stays for history.
- **Session-backlog promotion** (this doc §8): re-run `python3 scripts/cos_session_backlog.py --write` periodically (currently broken under Python 3.14 — `dataclass(slots=True)` arg parsing issue; fix tracked as follow-up); copy `.cognitive-os/sessions/default/backlog.md` → `docs/06-Daily/reports/session-backlog-latest.md` to refresh tracked view.
