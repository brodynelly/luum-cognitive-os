# SCOPE: os-only
"""Portability proof for rules/agent-audit-before-commit.md."""
...
ARTIFACT = REPO_ROOT / "rules/agent-audit-before-commit.md"


def test_test_agent_audit_before_commit_loads_from_arbitrary_project_root(tmp_path: Path) -> None:
