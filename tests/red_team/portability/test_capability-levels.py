# SCOPE: os-only
"""Portability proof for rules/capability-levels.md."""
...
ARTIFACT = REPO_ROOT / "rules/capability-levels.md"


def test_test_capability_levels_loads_from_arbitrary_project_root(tmp_path: Path) -> None:
