# SCOPE: os-only
"""Portability proof for rules/step-files.md."""
...
ARTIFACT = REPO_ROOT / "rules/step-files.md"


def test_test_step_files_loads_from_arbitrary_project_root(tmp_path: Path) -> None:
