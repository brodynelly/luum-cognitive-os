# SCOPE: os-only
"""Portability proof for templates/agent-research-only.md."""
...
ARTIFACT = REPO_ROOT / "templates/agent-research-only.md"


def test_test_agent_research_only_loads_from_arbitrary_project_root(tmp_path: Path) -> None:
