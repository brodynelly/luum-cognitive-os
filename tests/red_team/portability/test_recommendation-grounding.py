# SCOPE: os-only
"""Portability proof for rules/recommendation-grounding.md."""
...
ARTIFACT = REPO_ROOT / "rules/recommendation-grounding.md"


def test_test_recommendation_grounding_loads_from_arbitrary_project_root(tmp_path: Path) -> None:
