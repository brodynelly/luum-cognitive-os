...
CLI:
    cos_executor.py --daemon           start (idempotent)
    cos_executor.py --status           print ALIVE or DEAD + pid
    cos_executor.py --stop             send SIGTERM to running daemon
    cos_executor.py --foreground       run in-process (for tests)
"""
