# SCOPE: os-only
"""Portability proof for rules/anti-hallucination.md."""
...
ARTIFACT = REPO_ROOT / "rules/anti-hallucination.md"


def test_test_anti_hallucination_loads_from_arbitrary_project_root(tmp_path: Path) -> None:
