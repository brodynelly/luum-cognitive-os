...
- [Headless Self-Improvement Proposer](architecture/headless-self-improvement-proposer.md) — propose-only audit→fix loop that needs no dashboard and keeps human approval mandatory.
