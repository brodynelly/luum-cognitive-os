# SCOPE: os-only
"""Portability proof for rules/model-directive.md."""
...
ARTIFACT = REPO_ROOT / "rules/model-directive.md"


def test_test_model_directive_loads_from_arbitrary_project_root(tmp_path: Path) -> None:
