...
Usage:
  python3 scripts/aspirational-audit.py           # full run, writes jsonl + report
  python3 scripts/aspirational-audit.py --dry-run # no writes, print summary
  python3 scripts/aspirational-audit.py --json    # machine-readable summary to stdout
  python3 scripts/aspirational-audit.py --threshold 0.4  # exit 1 if dormant+asp ratio > 40%
"""
