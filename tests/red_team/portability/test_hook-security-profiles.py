# SCOPE: os-only
"""Portability proof for rules/hook-security-profiles.md."""
...
ARTIFACT = REPO_ROOT / "rules/hook-security-profiles.md"


def test_test_hook_security_profiles_loads_from_arbitrary_project_root(tmp_path: Path) -> None:
